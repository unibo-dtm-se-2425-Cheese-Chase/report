...
- To access the repository containing all of the project work discussed in the report, click [here](https://github.com/unibo-dtm-se-2425-Cheese-Chase/artifact.git).
...
1. Assuming that Ruby is correctly installed, you need to clone your report repository on your machine:
    ...
    ```bash
    git clone https://github.com/unibo-dtm-se-2425-Cheese-Chase/report
    ```
